...
## Примерное виденье проекта
[Макет Figma](https://www.figma.com/design/34cFyykYgfm4Dag8mR7Pkk/anottater?node-id=26-6079&t=bNPEAO5MKT96erzD-1)
...
Был использован JMeter, запрос на получение всех типов разметок исходного пользователя. Запросы создавались в 100 потоках, каждый поток
выполнял 100 запросов.

Соответствующие графики:

![График при испольовании балансировки](imgs/response_graph_multi.png)
![График при отсутствии балансировки](imgs/resp_time_single_v2.png)
