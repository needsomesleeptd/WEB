...
type IDocumentHandlerV1 interface {
...
func NewDocumentHandlerV1(logSrc *logrus.Logger, serv service.IDocumentService) DocumenthandlerV1 {
	return DocumenthandlerV1{
		logger:     logSrc,
		docService: serv,
	}
}
...
func (h *DocumenthandlerV1) GetDocumentByID() http.HandlerFunc {
...
func (h *DocumenthandlerV1) GetReportByID() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req RequestID
		err := render.DecodeJSON(r.Body, &req)
		if err != nil {
...
func (h *DocumenthandlerV1) GetDocumentsMetaData() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func (h *DocumenthandlerV1) CreateReport() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		userID := r.Context().Value(auth_middleware.UserIDContextKey).(uint64)
